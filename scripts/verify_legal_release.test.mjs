...
const current={product:'contract-review',version:'1.0.0',max_only:true,model_gateway:'ydata',model_selection_version:1,review_engine_version:2,followup_questions:true,collaboration_version:1,audit_foundation_version:1,draft_release_version:1,transaction_brief_version:1,evidence_screening_version:1};
...
for(const field of ['max_only','model_gateway','model_selection_version','review_engine_version','followup_questions','collaboration_version','audit_foundation_version','draft_release_version','transaction_brief_version','evidence_screening_version']) {
