...
summary={k:result.get(k) for k in ('provider','status','warnings')}
summary['sources']=[{k:s[k] for k in ('url','title','retrieved_at','content_hash','source_status','version_status')} for s in result['sources']]
