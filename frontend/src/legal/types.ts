...
export type Policy = { id: string; title: string; text: string; version: number; contract_type: string };
...
export type Profile = { our_party?: { block_id: string; quote: string }; transaction_context?: TransactionContext; review_mode?: 'standard' | 'multi_agent'; transaction_date?: string; model?: { id: string; provider: string }; our_role?: string; contract_type?: string; instructions?: string };
