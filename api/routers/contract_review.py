...
def _review_view(r: dict):
    ...
    return {'transaction_brief': p.get('transaction_brief'), 'evidence_health': evidence_health(p.get('searches', {}), sources),
            'id': r['id'], 'contract_id': r['contract_id'], 'status': r['status'], 'created_at': r['created_at'],
