...
def test_rag_unlimited_user_bypasses_rag_rate_limit_without_admin_role(tmp_path):
    asyncio.run(_rag_unlimited_user_bypasses_rag_rate_limit_without_admin_role(tmp_path))


async def _rag_unlimited_user_bypasses_rag_rate_limit_without_admin_role(tmp_path):
    db_path = tmp_path / "auth.db"
    ...
    assert result["bypassed"] is True
    assert result["reason"] == "unlimited_user"
